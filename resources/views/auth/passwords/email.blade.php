            ...
            <div class="m-8">
                ...
                <div class="bg-white rounded">
                    ...
                    <form class="w-full border border-t-0 rounded-b p-8" action="{{ route('password.email') }}" method="POST">
                        ...
                        <div class="text-lg text-grey-darkest text-center mb-6">Reset password</div>
                        ...
                        <div class="block mb-4">
                            <div class="relative">
                                ...
                                <input autofocus required type="email" name="email" placeholder="Email address" value="{{ old('email') }}" class="block appearance-none outline-none w-full h-full border focus:border-blue bg-grey-lightest text-grey-darker py-3 pr-3 pl-9 rounded{{ $errors->first('email', ' border-red') }}" />
                            </div>
                        ...
                        <div class="text-center text-sm text-grey-dark">
                            ...
                            or <a class="font-semibold text-grey-darker no-underline hover:underline" href="{{ route('register') }}">create an account</a>
                        </div>
                    </form>
                </div>
            </div>
